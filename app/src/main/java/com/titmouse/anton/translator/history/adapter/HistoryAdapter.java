...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.MyViewHolder> {
	...
	public HistoryAdapter(final List<Translate> translateEntityList) {
	...
	@Override
	public HistoryAdapter.MyViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
